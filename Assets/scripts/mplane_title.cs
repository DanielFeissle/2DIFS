...
public class mplane_title : MonoBehaviour
{
    int alternator1 = 1;
    ...
    void Start()
    {
        ...
        for (int i = 0; i < 3; i++)
        {
            if (i == 0)
            {
                GameObject wheely = GameObject.Find("plane_wheel_" + i + "_title");
    ...
    private void controllerCheck()
    {
        ...
        if (GameObject.Find("altimeter_title").GetComponent<alt_gauge>().act_alt < 15 && toggleLandGear == true)
        {
        ...
        if (Input.GetButtonDown("EJECT") && peject == false)
        {
            ...
            alt_gauge txt_ground_dist_alt = GameObject.Find("altimeter_title").GetComponent<alt_gauge>();
            ...
            GameObject.Find("altimeter_title").GetComponent<CameraController>().player = indeje;
...
ani.GetCurrentAnimatorStateInfo(0).normalizedTime >= 1.0f)
        ...
        if (GameObject.Find("altimeter_title").gameObject.GetComponent<menu_runtime>().specButtonStat == -1)
        {
            if (onground == true)
            {
                rb.mass = 60;
            ...
            if ((Input.GetButtonDown("Fire3") && (pdead == true || peject == true) || (plane_recovered == true && peject == true)) || autoProgressCleared == true)
            {
                ...
                if (pdead == true || peject == true)
                {
                    ...
                    maxAlt = 0;
                    tempAlt = 0;
                    GameObject.Find("altimeter_title").GetComponent<alt_gauge>().act_alt = 0;
                    ...
                    if (pdead == true || peject == true)
                    {
                        if (GameObject.Find("ind_pi"))
                        {
                            ...
                            GameObject.Find("altimeter_title").GetComponent<CameraController>().player = this.gameObject;
                            //if (eject_cr == false)
                            // {
           ...
           //     throttle.GetComponent<Slider>().value = engineSpool;
            ...
            //    txtAlt.GetComponent<Text>().text = "SEA: " + altitude;
                ...
                if (Time.time > nextUsage) //continue scrolling
                {
                    ...
                    if (GameObject.Find("altimeter_title").GetComponent<alt_gauge>().act_alt > 100)
                    {
                ...
                */
                //6-4-2024
                //lolo
                //    tempAlt = GameObject.Find("altimeter_title").GetComponent<alt_gauge>().act_alt;
                tempAlt = altitude;
                if (tempAlt > maxAlt)
                {
                    maxAlt = tempAlt;
            ...
            //    txtSpd.GetComponent<Text>().text = "Speed: " + Math.Round(Speed, 2);
                ...
                if (onground == false && peject == false)
                {
                    ...
                    if (transform.rotation.eulerAngles.z > 0 && transform.rotation.eulerAngles.z < 45)
                    {
                        ...
                        if (engineSpool > 90 && GameObject.Find("altimeter_title").GetComponent<alt_gauge>().act_alt < 100)
                        {
                        ...
                        /*
                        if (GameObject.Find("altimeter_title").GetComponent<alt_gauge>().act_alt < 150)
                        {
                            rb.mass = 60;
                            rb.drag = .5f;
                            heavyMass = false;
    ...
    void Update()
    {
        if (GameObject.Find("checkerBoard(256x256)"))
        {
            ...
            if (pdead == false && peject == false && GameObject.Find("altimeter_title").gameObject.GetComponent<menu_runtime>().specButtonStat == -1)
            {
    ...
    private IEnumerator EjectControledPowerOff()
    {
        ...
        while (engineSpool > 0)
        {
            ...
            if (GameObject.Find("altimeter_title").GetComponent<alt_gauge>().act_alt > 2)
            {
